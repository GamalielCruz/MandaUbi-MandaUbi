    ...
    <footer>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link
                  className="text-gray-600 transition hover:text-gray-900"
                  href="https://www.instagram.com/enviaubi"
                >
                  Instagram
                </Link>
              </li>
              <li>
                <Link
                  className="text-gray-600 transition hover:text-gray-900"
                  href="https://www.facebook.com/people/EnviaUbi/61570036246600/"
                >
                  Facebook
                </Link>
              </li>
          ...
          {/* 5th block */}
          <div className="relative space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-medium">Social</h3>
            <ul className=" flex gap-1">
              <li>
                <Link
                  className="flex items-center justify-center text-blue-500 transition hover:text-blue-600"
                  href="https://www.tiktok.com/@enviaubi"
                  aria-label="TikTok"
                >
